                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold tabular-nums">
                    ...
                    {(r.previous_carryover ?? 0) > 0 && (
                      <span className="ml-1.5 inline-flex items-center gap-0.5 rounded bg-amber-500/25 px-1.5 py-0.5 text-[9px] font-bold text-amber-200">
...
function HqCarryoverChainCard({
  ...
  return (
    <div className="mt-3 rounded-lg border border-amber-400/30 bg-amber-500/5 p-2.5">
      <p className="mb-2 flex items-center gap-1.5 text-[11px] font-bold text-amber-200">
      ...
      {belowMinimum && (
        <p className="mt-2 flex items-start gap-1.5 rounded bg-amber-500/25 px-2 py-1.5 text-[10px] text-amber-100">
      ...
      {!belowMinimum && prev > 0 && settlement.status !== 'paid' && (
        <p className="mt-2 flex items-start gap-1.5 rounded bg-emerald-500/25 px-2 py-1.5 text-[10px] text-emerald-200">
      ...
      {(source || child) && (
        <div className="mt-2 flex items-center gap-1.5 text-[10px]">
          ...
          <div className="rounded bg-amber-500/25 px-2 py-1 font-bold text-amber-100 ring-1 ring-amber-400/40">
...
function HqChainNode({ link, label }: { link: CarryoverChainLink | null; label: string }) {
  ...
  return (
    <div className={`rounded bg-bg-deep px-2 py-1 ring-1 ${
      applied ? 'ring-emerald-400/40 text-emerald-200' : 'ring-line/20 text-ink'
    }`}>
