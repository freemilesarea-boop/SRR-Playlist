...
const HEALTH_TONE: Record<string, string> = {
  ok: 'bg-emerald-500/25 text-slate-900 dark:text-emerald-200 dark:text-emerald-300 ring-emerald-400/50',
  unknown: 'bg-ink/10 text-ink-mute ring-line/10',
  unreachable: 'bg-rose-500/25 text-slate-900 dark:text-rose-200 dark:text-red-300 ring-rose-400/50',
  wrong_mime: 'bg-amber-500/25 text-slate-900 dark:text-amber-200 dark:text-amber-300 ring-amber-400/50',
  empty: 'bg-amber-500/25 text-slate-900 dark:text-amber-200 dark:text-amber-300 ring-amber-400/50',
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex gap-1.5">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg bg-sky-100 px-3 py-1.5 text-xs font-semibold text-slate-900 dark:text-sky-200 ring-1 ring-sky-400/50 hover:bg-sky-200 disabled:opacity-50 dark:bg-sky-500/25 dark:text-sky-200 dark:hover:bg-sky-500/25"
          >
              ...
              <tbody>
                {issues.map((it) => (
                  <tr key={it.track_id} className="border-b border-line/10 last:border-b-0 hover:bg-bg-hover">
                    ...
                    <td className="px-3 py-2 text-[11px] text-slate-900 dark:text-rose-200 dark:text-red-300">
