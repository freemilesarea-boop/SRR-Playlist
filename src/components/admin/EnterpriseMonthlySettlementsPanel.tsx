...
function CarryoverChainCard({
  ...
  return (
    <div className="mt-3 rounded-lg border border-amber-400/30 bg-amber-500/5 p-3">
      ...
      {/* 미달 gap 표시 */}
      {belowMinimum && (
        <div className="mt-2 flex items-start gap-1.5 rounded bg-amber-500/25 px-2 py-1.5 text-[10px] text-amber-100">
      ...
      {!belowMinimum && min > 0 && (
        <div className="mt-2 flex items-start gap-1.5 rounded bg-emerald-500/25 px-2 py-1.5 text-[10px] text-emerald-200">
      ...
      {(source || child) && (
        <div className="mt-3 flex items-center gap-2 text-[10px]">
          ...
          <div className="rounded bg-amber-500/20 px-2 py-1 font-bold text-amber-100 ring-1 ring-amber-400/40">
