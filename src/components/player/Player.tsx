...
export default function Player() {
  ...
  return (
    <>
      ...
      <div className="app-player fixed inset-x-0 bottom-[5.25rem] z-20 mx-auto max-w-3xl px-3 pl-safe pr-safe sm:bottom-[5.5rem] sm:px-4 lg:left-60 lg:right-0 lg:bottom-4 lg:max-w-[min(960px,calc(100vw-15rem-4rem))] lg:px-6">
        <button
