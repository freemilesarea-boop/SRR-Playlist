...
export const OPERATOR_ROUTES: OperatorRouteEntry[] = [
  ...
  { id: 'store-detail', label: '매장 상세', description: '매장별 상세·재생 설정', canonicalPath: '/ops/stores/:storeId', componentKey: 'store-detail', category: 'stores', keywords: ['매장 상세'], aliases: ['store detail'], roles: AH, breadcrumb: ['매장', '매장 상세'], icon: 'Store', hiddenFromSidebar: true, searchable: false },
  // 매장별 재생 설정은 FranchiseManagementPanel(가맹점 관리) 안의 기능이라 별도 사이드바 항목은 없지만,
  // 검색("store override" / "매장별 재생설정")에서 명확히 이 라벨로 도달하도록 검색 전용(사이드바 숨김) 항목 제공.
  { id: 'store-playback-settings', label: '매장별 재생 설정', description: '가맹점 매장의 재생 설정(가맹점 관리 화면)', canonicalPath: '/ops/stores/playback-settings', legacyTab: 'franchise', componentKey: 'franchise', category: 'stores', keywords: ['매장별 재생설정', '매장 재생설정', '재생 설정', '매장 재생'], aliases: ['store override', 'playback settings', 'store playback'], roles: A, breadcrumb: ['매장', '매장별 재생 설정'], icon: 'Store', hiddenFromSidebar: true, searchable: true },
