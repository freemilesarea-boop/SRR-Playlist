...
import { withTimeout, withRetry, friendlyUploadError, getCurrentUserFast } from './artist/internal';
...
// X6.50 — 분할된 도메인 모듈 re-export (consumer 호환성 유지)
export * from './artist/moderation';
