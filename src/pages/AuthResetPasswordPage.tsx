  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-bg px-6 pt-safe pb-safe">
      <div className="w-full max-w-md space-y-6 animate-fade-in py-10">
        ...
        {done ? (
          <div className="flex items-start gap-2 rounded-xl border border-green-500/40 bg-green-500/20 p-4 text-sm text-slate-900 dark:text-green-200">
          ...
          <div className="flex items-start gap-2 rounded-xl border border-red-500/40 bg-red-500/20 p-3 text-sm text-slate-900 dark:text-red-200">
