...
> ⛔ **플레이스토어 심사 중에는 지우지 말 것.** `qa-store@deudda.test` 를
> Play Console 의 '로그인 세부정보'(구 앱 액세스)에 심사용 계정으로 등록해뒀다.
> 심사원이 로그인하지 못하면 그 자리에서 반려된다. 앱이 정식 출시되고
> Console 에서 그 계정을 내린 뒤에 지운다.
